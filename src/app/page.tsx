...
import { FAQ, PROCESS, SERVICES, SITE } from '@/lib/site';
      ...
      <section className="mx-auto max-w-6xl px-5 py-20 sm:px-8">
        ...
        <Reveal>
          <p className="mt-6 font-mono text-[12px] text-ink-faint">
            ...
            full breakdown on the <Link href="/process/" className="text-red-blood/80 hover:text-red-blood">process page</Link>.
          </p>
        </Reveal>
      </section>
